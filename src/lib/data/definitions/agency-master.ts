...
export const PROJECTS_SHOWCASE = [
  {
    id: 1,
    title: "E-commerce Équipement Sportif",
    category: "ecommerce",
  ...
  {
    id: 3,
    title: "Réseau d'Agences Immobilières",
    category: "sites",
  ...
  {
    id: 4,
    title: "Cave à Vins Indépendante",
    category: "ecommerce",
  ...
  {
    id: 5,
    title: "Studio de Bien-être & Yoga",
    category: "branding",
  ...
  {
    id: 6,
    title: "Cabinet Médical Pluridisciplinaire",
    category: "sites",
