...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Exclude composite slugs like "site-web-restaurant/biarritz" (city combos for the
  // metier silo, see services-metier.ts METIER_CITY_COMBOS): those are generated by
  // the "Combo Pages" loop below and would otherwise be pushed twice.
  const services = SERVICES.filter(s => !CITIES.find(c => c.slug === s.slug) && !s.slug.includes('/'))
