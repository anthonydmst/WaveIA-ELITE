        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative w-full">
          <div className="text-center max-w-4xl mx-auto py-24 animate-hero-fade-up">
            ...
            <div className="flex flex-wrap justify-center items-center gap-4">
              ...
              <a href="#projets" className="inline-flex items-center gap-2 bg-transparent text-muted-foreground text-sm px-7 py-3.5 rounded-full border border-border hover:border-ocean hover:text-ocean transition-all">
            ...
            <div className="mt-14 flex justify-center gap-8 md:gap-12 flex-wrap">
              <div className="text-center">
                ...
                <span className="text-xs text-muted-foreground uppercase tracking-wider">Projets livrés</span>
              </div>
              <div className="text-center">
                <strong className="block font-heading text-3xl font-bold text-ocean">3×</strong>
                <span className="text-xs text-muted-foreground uppercase tracking-wider">Plus rapide vs classique</span>
              </div>
              <div className="text-center">
                <strong className="block font-heading text-3xl font-bold text-ocean">98%</strong>
                <span className="text-xs text-muted-foreground uppercase tracking-wider">Clients satisfaits</span>
              </div>
            </div>
            
            <p className="mt-9 text-xs text-muted-foreground/70 tracking-wider">
              <b className="text-muted-foreground font-normal">📍 Pays Basque — Bayonne · Biarritz · Anglet</b>
            </p>
          </div>
        </div>
      </section>
