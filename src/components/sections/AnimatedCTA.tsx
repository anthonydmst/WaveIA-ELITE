  ...
  return (
    <section className="relative py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl group border border-white/10 shadow-2xl animate-scale-in">
          ...
          <div className="relative px-8 py-20 lg:py-28 lg:px-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in delay-300">
              ...
              <Link
                href="/tarifs"
                className="group/btn px-10 py-5 bg-white/10 hover:bg-white/20 text-background font-semibold rounded-full border border-white/30 hover:border-white/50 transition-all duration-300 flex items-center gap-3"
              >
            ...
            {/* Trust Badges */}
            <div className="flex flex-wrap items-center justify-center gap-6 mt-12 pt-8 border-t border-white/10 animate-in delay-400">
