          ...
          {pricingPreviews.map((pricing, index) => (
            ...
            >
              <Link href={pricing.href} className="block h-full">
                ...
                {/* Main Card */}
                <div className="relative h-full p-8 bg-glass-bg backdrop-blur-sm rounded-2xl border border-glass-border overflow-hidden transition-all duration-500 group-hover:border-transparent group-hover:translate-y-[-4px] shadow-card group-hover:shadow-card-hover">
