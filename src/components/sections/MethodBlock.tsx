        ...
        {steps.map((step, index) => {
          ...
          return (
            <div key={index} className="w-full flex flex-col items-center">
              ...
              <div className="w-10 h-10 rounded-full bg-ocean flex items-center justify-center shrink-0 z-10 shadow-[0_0_15px_var(--ocean)]">
                  ...
                  <>
                    <div className="text-center md:text-left">
                      <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                        ...
                        <div className="w-7 h-7 rounded-full bg-ocean text-white text-xs font-bold flex items-center justify-center font-heading">
                          {index + 1}
                        </div>
                      </div>
