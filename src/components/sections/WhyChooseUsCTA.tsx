...
export function WhyChooseUsCTA() {
  return (
    <section className="relative py-24 overflow-hidden bg-background">
      {/* Glow Effects */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,var(--ocean)_0%,transparent_50%)] opacity-[0.05]" />
      ...
      <div className="relative max-w-5xl mx-auto px-6 text-center mb-16">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
          ...
          <span className="italic text-ocean-light font-heading">votre acquisition ?</span>
        </h2>
      ...
      <div className="relative max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col p-8 sm:p-10 rounded-2xl bg-glass-bg border border-glass-border hover:border-ocean/50 hover:shadow-[0_10px_30px_rgba(14,165,233,0.1)] transition-all duration-300">
          ...
          <Link href="#calendly" className="inline-flex w-full items-center justify-center gap-2 px-6 py-4 rounded-xl bg-ocean hover:bg-ocean-dark text-white font-semibold transition-all shadow-[0_0_20px_rgba(14,165,233,0.3)] hover:shadow-[0_0_30px_rgba(14,165,233,0.5)]">
        ...
        <div className="flex flex-col p-8 sm:p-10 rounded-2xl bg-glass-bg border border-glass-border hover:border-ocean/50 hover:shadow-[0_10px_30px_rgba(14,165,233,0.1)] transition-all duration-300">
          ...
          <Link href="#devis" className="inline-flex w-full items-center justify-center gap-2 px-6 py-4 rounded-xl bg-ocean hover:bg-ocean-dark text-white font-semibold transition-all shadow-[0_0_20px_rgba(14,165,233,0.3)] hover:shadow-[0_0_30px_rgba(14,165,233,0.5)]">
